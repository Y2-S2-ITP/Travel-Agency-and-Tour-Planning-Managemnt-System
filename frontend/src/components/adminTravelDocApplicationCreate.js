...
export default class adminTravelDocApplicationCreate extends Component {
   ...
   onSubmit = (e) =>{
    ...
    axios.post('http://localhost:8000/TravelDoc/save',data).then((res) =>{
        if(res.data.success){
            this.setState(
                {
                 country:"",
                ...
                <div className="row display-table-row">
                    ...
                    <div>
                        <div className="col-md-8 mt-4 mx-auto">
                            <h1 className="h3 mb-3 font-weight-normal">Create new Tarvel Document Application Link</h1>
