            ...
            <div>
                ...
                <ul className="list-group">
                    <li className="list-group-item">
                        <Link className="nav-link" style={{fontSize:"16px"}} to="/admin/users">View User Profiles</Link>
                    </li>
    ...
    const adminInfo = () => {
        return (
            <div className="mb-5" style={{width:'60%'}}>
                <h3 className=" text-white bg-info" style={{height:'3em',textAlign:"center"}}>Admin Information</h3>
                <ul className="row">
                    ...
                    <li className="list-group-item " style={{ color: 'red',width:'95%',fontSize:"16px" }}>
